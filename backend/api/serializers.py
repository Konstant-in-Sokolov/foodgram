...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    # ======================================================
    # ПРАВИЛЬНАЯ ОБРАБОТКА НЕПРАВИЛЬНОГО ФОРМАТА INGREDIENTS
    # ======================================================
    def to_internal_value(self, data):
        ...
        if isinstance(ingredients, dict):
            data['ingredients'] = list(ingredients.values())
    ...
    # ======================================================
    # ГЛАВНОЕ ИСПРАВЛЕНИЕ — ПРАВИЛЬНОЕ СОЗДАНИЕ СВЯЗЕЙ
    # ======================================================
    def add_ingredients(self, ingredients_data, recipe_instance):
        ...
        for item in ingredients_data:
            ...
            # Если id — число, превращаем в Ingredient instance
